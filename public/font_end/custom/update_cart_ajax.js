    ...
    $('.val_update_cart_change').bind('keyup mouseup blur', function () {
        ...
        if(qty != '' && qty != null){
            ...
            {
                $('.val_quantity_update_cart_'+cart_id).val(1);
                Swal.fire({
                    position: 'top-end',
                    icon: 'error',
        ...
        $('.btn_up_update_cart').click(function(){
            ...
            if($('.check_item_'+cart_id).is(':checked')){
                if(qty <= max_val){
                    ...
                    $('.show_total_price_check_item_cart').html(formatNumber(total_price_all_item_check)+'₫');
        ...
        $('.btn_up_update_cart').click(function(){
            ...
            if($('.check_item_'+cart_id).is(':checked')){
                if(qty <= max_val){
                    ...
                    $('.show_total_price_check_item_cart').html(formatNumber(tota_price_hidden)+'₫');
