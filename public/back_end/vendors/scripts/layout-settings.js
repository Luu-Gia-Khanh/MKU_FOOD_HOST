(function() {
	...
	$(document).ready(function() {
		...
		sidebar_dark.click(function() {
			'use strict';
			jQuery(this).addClass('active');
            $('#logo_left_side_admin').attr('src','https://mkufood.tk/public/upload/logo_mku_9.svg');
		...
		sidebar_light.click(function() {
			'use strict';
			jQuery(this).addClass('active');
            $('#logo_left_side_admin').attr('src','https://mkufood.tk/public/upload/logo_mku_10.svg');
