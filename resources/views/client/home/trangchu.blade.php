            ...
            <ul class="grid-twice-item">
                <li>
                    <div class="biolife-banner biolife-banner__style-11">
                        <div class="banner-contain">
                            <div class="media">
                                <a href="#" class="bn-link"><img src="{{ asset('public/upload/bg-vege1.jpg') }}" width="281" style="height: 351px" alt=""></a>
                            </div>
                ...
                <li>
                    <div class="biolife-banner biolife-banner__style-12">
                        <div class="banner-contain">
                            <div class="media">
                                <a href="#" class="bn-link"><img src="{{ asset('public/upload/bg-all.jpg') }}" width="281" height="358" alt=""></a>
                            </div>
                            <div class="text-content">
