        ...
        <div id="main-content" class="main-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="block-item head__title" style="display: flex; justify-content: space-between">
                ...
                <div class="tab__head-text--see-all" style="padding-right: 10px">
                    <a href="{{ URL::to('show_all_product_recommend') }}"
                        class="tab__head-link" style="font-size: 10px">
        ...
        <div id="main-content" class="main-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="block-item recently-products-cat md-margin-bottom-39 custom-container-product">
                <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile"
                    data-slick='{"rows":2,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":4,
                    ...
                    @foreach ($all_product_join as $product)
                        ...
                        <li class="product-item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                            <div class="contain-product layout-default content_product_sm"
                                style="height: 285px; width:150px; border-radius: 7px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
                                <div class="product-thumb">
                                    ...
                                    <a href="{{ URL::to('product_detail_slug/' . $product->slug) }}" class="link-to-product btn_recently_viewed" data-id="{{ $product->product_id }}"
                                        ...
                                        <img src="{{ asset('public/upload/' . $product->product_image) }}" alt="dd"
                                         style="width: 95%; height: 120px; padding-left: 2.5%; padding-top: 5px; border-radius: 7px"
                                ...
                                <div class="info">
                                    ...
                                    <div class="slide-down-box">
                                        <div class="buttons" style="margin-top: 5px">
                                            ...
                                            {{-- end wish list --}}
                                            @if (Session::get('customer_id'))
                                                <button href="#" class="btn add-to-cart-btn btn-sm add_cart_one"
                                                        data-id="{{ $product->product_id }}"
                                                        style="font-size: 12px; width:80%; margin-left:10%; background-color: #7faf51 !important; color:white">
