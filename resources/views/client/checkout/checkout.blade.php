    ...
    <div class="content-header">
        <div class="container">
            <div class="content-both">
                ...
                <div class="content-title-page cus_main_color">
                    Thanh Toán
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="cus_view place_trans">
                        <div class="content-title-address-trans">
                            <h4 class="title_place_trans cus_main_color">
                                <i class="biolife-icon icon-location"></i> Địa Chỉ Nhận Hàng
                            </h4>
                        ...
                        <div class="address_static_show">
                            @if ($static_trans)
                                <div class="static-address hidden_address">
                                    ...
                                    <i class="static static_change cus_main_color">Mặc Định</i>
                                    <button type="button" class="btn-green btn_change_address_trans cus_main_bg cus_main_text"
                                        data-toggle="collapse" data-target="#change_address_trans">THAY ĐỔI
                                    </button>
                                </div>
                            @else
                            ...
                            @if (count($cus_trans) > 0)
                                <div id="change_address_trans" class="collapse">
                                    @foreach ($cus_trans as $trans)
                                        <p>
                                            ...
                                            <label for="{{ $trans->trans_id }}" class="static-address">
                                                ...
                                                @if ($trans->trans_status == 1)
                                                    <i class="static static_choose_{{ $trans->trans_id }} cus_main_color">Mặc Định</i>
                                                @else
                                    ...
                                    <div class="content-btn">
                                        <button type="button" class="btn-green btn_change_address_radio_button cus_main_bg cus_main_text" data-toggle="collapse" data-target="#change_address_trans">Hoàn Thành</button>
                    ...
                    <div class="cus_view">
                        ...
                        <div class="total-price-pay">
                            ...
                            <div class="temporary-price cus_main_color">{{ number_format($total_temporary_price, 0, ',', '.') }}đ
                            </div>
                        </div>
                    </div>
                    <div class="cus_view">
                        <div class="content-voucher">
                            ...
                            <h4 class="titel-voucher cus_main_color">MKU_FOOD Voucher</h4>
                            <div class="discount_voucher"></div>
                            <input type="hidden" value="" class="val_hidden_discount_voucher">
                            <button type="button" id="btn-open-model-voucher" class="choose-voucher btn-green cus_main_bg cus_main_text"
                                data-toggle="modal" data-target="#modal-choose-voucher">Chọn Voucher
                            </button>
                    ...
                    <div class="view-payment">
                        <div class="content-payment-method row">
                            ...
                            <button type="button" class="btn-green btn-change-method btn_change_method_pay cus_main_bg cus_main_text">
                                Thay Đổi
                            </button>
                        </div>
                    </div>
                    <div class="view-summary">
                        <div class="content-total-summary">
                            ...
                            @endphp
                            <div class="val-total-summary cus_main_color">{{ number_format($summary_total_order, 0, ',', '.') }}đ</div>
                        ...
                        <div class="view-btn-buy">
                            <div class="title-rule">Nhấn "Đặt hàng" đồng nghĩa với việc bạn đồng ý tuân theo
                                <a href="https://mkufood.tk/" target="_blank" rel="noopener noreferrer">Điều khoản MKU_FOOD
                                </a>
                            </div>
                            <button type="button" class="btn-dathang btn_dathang cus_main_bg cus_main_text">Đặt Hàng</button>
                        </div>
                    </div>
            </form>
        </div>
        ...
        <div class="modal-content container">
            ...
            <div class="modal-body-cus">
                <div class="content-enter-voucher">
                    ...
                    <button type="button" class="btn-green btn-voucher col-2 btn_apply_voucher cus_main_bg cus_main_text" disabled>ÁP DỤNG</button>
                </div>
                                        ...
                                        <div class="container__voucher-item" style="background-color: #f8f8f8; height: 88px;">
                                            ...
                                            <div class="container__voucher-item--right">
                                                ...
                                                <div class="voucher-item--right-btn">
                                                    <a href="#" class="choose_voucher choose_voucher_{{ $product_voucher->voucher_code }} cus_main_bg cus_main_text"
                                                        data-id="{{ $product_voucher->voucher_code }}">Dùng Ngay
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
