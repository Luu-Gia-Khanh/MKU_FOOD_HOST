        ...
        <div class="container pd-40 center">
            ...
            <div class="content-bill">
                <div class="content-text-bill">
                    ...
                    @endif
                    <div class="" style="padding-bottom: 10px">Bạn đã hủy thanh toán đơn hàng tại <strong>MKU_FOOD</strong></div>
                    <div class="content-btn" style="display: flex; justify-content: center">
                        <a href="{{ URL::to('show_cart') }}" class="btn btn-success" style="margin: 5px">Quay Lại Giỏ Hàng</a>
                    </div>
                </div>
            </div>
        </div>
