	...
	<div class="error-page d-flex align-items-center flex-wrap justify-content-center pd-20">
		<div class="pd-10">
			<div class="error-page-wrap text-center">
				...
				<p>Giờ đây bạn có thể đăng nhập vào hệ thống và mua sắm tại MKU_FOOD.<br>Chúc bạn một ngày vui vẻ!</p>
				<div class="pt-20 mx-auto max-width-200">
					<a href="{{ URL::to('login_client') }}" class="btn btn-block btn-lg" style="background-color: #7faf51; color: white">Đăng nhập ngay</a>
				</div>
			</div>
		</div>
	</div>
