	...
	<div class="error-page d-flex align-items-center flex-wrap justify-content-center pd-20">
		<div class="pd-10">
			<div class="error-page-wrap text-center">
				<h2 class="pd-30">Bạn đã đăng ký thành công!</h2>
				<p>Vui lòng kiểm tra lại email để xác thực tài khoản.<br> Sau khi kích hoạt tài khoản qua email, bạn sẽ được trải nghiệm mua sắm tại MKU_FOOD.<br>Chúc bạn một ngày vui vẻ!</p>
				<div class="pt-20 mx-auto max-width-200">
					<a href="https://mail.google.com/" class="btn btn-block btn-lg" style="background-color: #7faf51; color: white">Chuyển đến email</a>
				</div>
			</div>
		</div>
	</div>
